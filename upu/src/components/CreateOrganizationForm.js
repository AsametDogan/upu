...
const CreateOrganizationForm = ({ organizationFormClose, organizationFormOpen }) => {
  return (
    <div>
      <Dialog
        fullScreen
        open={organizationFormOpen}
        onClose={organizationFormClose}
      ...
      >
        ...
        >
          <div className="w-full h-full flex items-center justify-end px-8">
            <button onClick={organizationFormClose}>
        ...
        <div className="w-full flex justify-center mt-[70px]">
          <div className="w-[34%] sm:w-[80%] h-full my-[7%] flex flex-col justify-items-center gap-16 sm:gap-16">
            <h1 className="text-[32px] w-full sm:text-2xl">Organizasyon Oluştur</h1>
